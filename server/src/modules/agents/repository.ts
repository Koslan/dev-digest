...
export class AgentsRepository {
  ...
  /**
   * How many skills each agent in this workspace links to, as agentId → count.
   * One grouped query for the whole grid; agents with no skills are absent from
   * the map, so the caller defaults them to 0.
   */
