...
1. The package `AGENTS.md` of the package you are about to touch (table below).
...
|---|---|
| API routes, services, DB, review orchestration | [server/AGENTS.md](server/AGENTS.md) |
| Pages, components, data fetching, UI state | [client/AGENTS.md](client/AGENTS.md) |
| Prompt assembly, LLM calls, grounding gate, scoring | [reviewer-core/AGENTS.md](reviewer-core/AGENTS.md) |
| Browser flows, regression coverage of the UI | [e2e/AGENTS.md](e2e/AGENTS.md) |
...
1. Read the package `AGENTS.md`, its `docs/`, `specs/` and `insights/INSIGHTS.md`
